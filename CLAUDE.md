...
- 版を上げるときは、フッターの `#appVersion` に加えて `index.html` の `js/app.js?v=` と `js/app.js` 先頭の `./core.js?v=` も同じ版にする。版を変えずに JS を直すときは `?v=1.5.3-2` のように枝番を付ける（GitHub Pages の 10 分キャッシュで新旧の app.js／core.js が混ざるのを防ぐ。v1.5.3 から）
