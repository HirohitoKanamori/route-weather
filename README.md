...
公開版 v1.0.2（2026-09-06、Beta）。バージョンは `index.html` フッターの `#appVersion` を更新し、`git tag vX.Y.Z` を打つ。
...
- テスター意見より：地図の経路線を通過時刻の予報で色分け（雨＝青、曇り＝グレー、晴れ＝オレンジ、予報範囲外＝点線）、コース全体の地図を 1080×1080 の画像にして共有（「地図を画像で共有」）
